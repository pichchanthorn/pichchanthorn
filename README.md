...
**🔍 Problem-Solving**
Hands-on project execution over theory-only learning

**🏗️ System Thinking**
Architecture, data flow, and long-term maintainability

</td>
<td width="50%">

**📈 Continuous Learning**
Build → measure → improve, applied consistently

**🤝 Leadership**
Founder experience running a community/startup since 2020
...
**Languages**
![](https://skillicons.dev/icons?i=html,css,js,php,python&theme=dark)

**Frameworks & Styling**
![](https://skillicons.dev/icons?i=bootstrap,tailwind&theme=dark)

**Databases**
![](https://skillicons.dev/icons?i=mysql,oracle&theme=dark)

**Tools & Platforms**
![](https://skillicons.dev/icons?i=git,vscode,figma,linux&theme=dark)
...
<i>open to internship & junior web developer opportunities 🚀</i>
